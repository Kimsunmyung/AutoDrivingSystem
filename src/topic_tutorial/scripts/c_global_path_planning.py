...
from morai_msgs.msg import PlannedLink #added
...
class globalPathPlanning :
    ...
    def __init__(self):
        ...
        self.planned_link_pub = rospy.Publisher('planned_link', PlannedLink, queue_size=1) #added
        ...
        self.planned_link = PlannedLink() #added
        self.planned_link.link_array = [] #added
        ...
        while not rospy.is_shutdown():
            ...
            self.planned_link_pub.publish(self.planned_link) #added
    ...
    def goal_callback(self,msg):
        if self.is_pose==True :
            ...
            #added
            if result:
                self.planned_link.link_array = []
                for link_id in path["link_path"]:
                    self.planned_link.link_array.append(link_id)

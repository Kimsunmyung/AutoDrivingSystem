...
class pure_pursuit :
    def __init__(self):
        ...
        self.ctrl_cmd_pub = rospy.Publisher('ctrl_cmd1',CtrlCmd, queue_size=1)
        self.ctrl_cmd_msg=CtrlCmd()
        self.ctrl_cmd_msg.longlCmdType=2

        self.pub_ctrl_msg = control_tx()###########################################################
        self.pub_ctrl = rospy.Publisher("/command1/", control_tx, queue_size=1)###########################################################
        ...
        self.pub_ctrl_msg.signal = 0###########################################################
        self.pub_ctrl_msg.lamp = 0###########################################################
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_path ==True and self.is_odom==True:
                ...
                # print(self.ctrl_cmd_msg.velocity )
                ...
                if self.is_look_forward_point: self.pub_ctrl_msg.drive_throttle = 20
                else: self.pub_ctrl_msg.drive_throttle = 0
                # print(self.ctrl_cmd_msg.steering*180/3.141592)
                # print(self.ctrl_cmd_msg.steering)
                
                self.pub_ctrl_msg.steer_degree=int(((self.ctrl_cmd_msg.steering)*180/3.141592)*2.5+90)

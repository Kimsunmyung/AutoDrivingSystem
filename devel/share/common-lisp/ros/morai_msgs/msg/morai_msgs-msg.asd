...
(defsystem "morai_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "FTGdata" :depends-on ("_package_FTGdata"))
    (:file "_package_FTGdata" :depends-on ("_package"))
    ...
    (:file "VehicleSpecDetail" :depends-on ("_package_VehicleSpecDetail"))
    (:file "_package_VehicleSpecDetail" :depends-on ("_package"))
    (:file "VehicleSpecDetails" :depends-on ("_package_VehicleSpecDetails"))
    (:file "_package_VehicleSpecDetails" :depends-on ("_package"))
